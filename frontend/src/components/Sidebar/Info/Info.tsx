    ...
    <div className="info-wrapper" onClick={closeInfo}>
        <div className="info" onClick={keepOpen}>
            ...
            <div className="grid-wrapper">
                <h3 className={showAbout ? "input-wrapper selected" : "input-wrapper"} onClick={() => setShowAbout(true)}>{t("informationTab.about")}</h3>
                <h3 className={showAbout ? "input-wrapper" : "input-wrapper selected"} onClick={() => setShowAbout(false)}>{t("informationTab.gettingStarted")}</h3>
            </div>
