...
def haversine_distance(lat1, lon1, lat2, lon2):
    # print("function: haversine_distance")
    R = 6371
...
def interpolate_point(lat1, lon1, lat2, lon2, distance_from_start):
...
def merge_close_results(results, max_distance=20):
...
def get_borderline_distance(bike_average_speed: float, walk_average_speed: float, bike_lock_time: int, bike_walk_distance: float):
